/* This file is automatically generated by configure.  Do not modify by hand. */
  if (should_init("fts_scalar")) init_fts_scalar();
  if (should_init("ftsRefTable")) init_ftsRefTable();
  if (should_init("ftsPtpTable")) init_ftsPtpTable();
  if (should_init("ftsNtpTable")) init_ftsNtpTable();
  if (should_init("ftsTimingTable")) init_ftsTimingTable();
  if (should_init("ftsClkTrap")) init_ftsClkTrap();
