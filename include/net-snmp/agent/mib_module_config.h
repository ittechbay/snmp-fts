...
/* Define if compiling with the fts-mib module files.  */
#define USING_FTS_MIB_MODULE 1
...
/* Define if compiling with the fts-mib/fts_scalar module files.  */
#define USING_FTS_MIB_FTS_SCALAR_MODULE 1
 
/* Define if compiling with the fts-mib/ftsRefTable module files.  */
#define USING_FTS_MIB_FTSREFTABLE_MODULE 1
 
/* Define if compiling with the fts-mib/ftsPtpTable module files.  */
#define USING_FTS_MIB_FTSPTPTABLE_MODULE 1
 
/* Define if compiling with the fts-mib/ftsNtpTable module files.  */
#define USING_FTS_MIB_FTSNTPTABLE_MODULE 1
 
/* Define if compiling with the fts-mib/ftsTimingTable module files.  */
#define USING_FTS_MIB_FTSTIMINGTABLE_MODULE 1
 
/* Define if compiling with the fts-mib/ftsClkTrap module files.  */
#define USING_FTS_MIB_FTSCLKTRAP_MODULE 1
