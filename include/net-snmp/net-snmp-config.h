...
#define NETSNMP_CONFIGURE_OPTIONS " '--with-cflags=-g' '--with-mib-modules=fts-mib' '--prefix=/root/snmp_app' '--exec-prefix=/root/snmp_app' '--disable-shared' '--disable-scripts' '--disable-ipv6' '--disable-manuals' '--disable-embedded-perl' '--enable-as-needed' '--disable-ucd-snmp-compatibility'"

/* default location to look for mibs to load using the above tokens and/or
   those in the MIBS envrionment variable */
#define NETSNMP_DEFAULT_MIBDIRS "$HOME/.snmp/mibs:/root/snmp_app/share/snmp/mibs"
...
#define SNMPLIBPATH "/root/snmp_app/lib/snmp"
#define SNMPSHAREPATH "/root/snmp_app/share/snmp"
#define SNMPCONFPATH "/root/snmp_app/etc/snmp"
#define SNMPDLMODPATH "/root/snmp_app/lib/snmp/dlmod"
